...
if (USE_OPENCL)
  ...
  if (USE_FPGA)
    ...
    list(APPEND OpenCL_LIBRARIES ${SDACCEL_LIBRARIES} OpenCL)
    set(CMAKE_CL_FLAGS --xp "'param:compiler.preserveHlsOutput=1'" --xp "'param:compiler.generateExtraRunData=true'" -s -I${PROJECT_SOURCE_DIR})
    set(FPGA_TARGET "hw" CACHE STRING "Target for the FPGA compiler.")
    set(AWS_PLATFORM "$ENV{AWS_PLATFORM}" CACHE STRING "The AWS platform.")
  else()
    find_package(OpenCL REQUIRED)
    if (NOT OpenCL_FOUND)
      MESSAGE(FATAL_ERROR
        "Could not find OpenCL installation")
    endif()
  endif()
