...
if (USE_OPENCL)
  ...
  if (USE_FPGA)
    ...
    set(CMAKE_CL_FLAGS ${CMAKE_CL_FLAGS} --xp "param:compiler.preserveHlsOutput=1" --xp "param:compiler.generateExtraRunData=true" -s)
    set(FPGA_TARGET "hw" CACHE STRING "Target for the FPGA compiler.")
    set(AWS_PLATFORM "" CACHE STRING "The AWS platform.")
  else()
