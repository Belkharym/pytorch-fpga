...
namespace torch { namespace opencl { namespace python {
  ...
  m.def(
      ...
      .def(
          ...
          [](at::Tensor& tensor,
            ...
            c10::optional<std::vector<c10::optional<c10::opencl::OpenCLStream>>> streams;
            if (py_streams) {
              py::handle handle = *py_streams;
              streams = THPUtils_PySequence_to_OpenCLStreamList(handle.ptr());
            }
